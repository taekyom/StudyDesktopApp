        ...
        private void FrmMain_MouseMove(object sender, MouseEventArgs e)
        {
            ...
            switch (this.mode)
            {
                ...
                case DrawMode.RECTANGLE:
                    g.DrawRectangle(this.eraser, new Rectangle(startP, new Size(prevP.X - startP.X, prevP.X - startP.Y)));
                    g.DrawRectangle(this.pen, new Rectangle(startP, new Size(currP.X - startP.X, currP.X - startP.Y)));
                    break;
                case DrawMode.CIRCLE:
                    g.DrawEllipse(this.eraser, new Rectangle(startP, new Size(prevP.X - startP.X, prevP.X - startP.Y)));
                    g.DrawEllipse(this.pen, new Rectangle(startP, new Size(currP.X - startP.X, currP.X - startP.Y)));
                    break;
        ...
        private void FrmMain_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            switch (this.mode)
            {
                case DrawMode.LINE:
                    ...
                    break;
                case DrawMode.RECTANGLE:
                    g.DrawRectangle(this.pen, new Rectangle(startP, new Size(endP.X - startP.X, endP.X - startP.Y)));
                    break;
                case DrawMode.CIRCLE:
                    g.DrawEllipse(this.pen, new Rectangle(startP, new Size(endP.X - startP.X, endP.X - startP.Y)));
                    break;
                case DrawMode.CURVED_LINE:
                    break;
                default:
